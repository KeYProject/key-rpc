...
class KeyServer(ServerBase):
    ...
    def meta_available_macros(
        self,
    ) -> typing.List[ProofMacroDesc]:
        """"""

        return self._call_sync("meta/available_macros", [])

    def meta_available_script_commands(
        self,
    ) -> typing.List[ProofScriptCommandDesc]:
        """"""
    ...
    def proof_goals(
        self, proof: ProofId, onlyOpened: bool, onlyEnabled: bool
    ) -> typing.List[NodeDesc]:
        """"""

        return self._call_sync("proof/goals", [proof, onlyOpened, onlyEnabled])

    def proof_macro(
        self, proof: ProofId, macroName: str, options: StrategyOptions
    ) -> MacroStatistic:
        """"""
    ...
    def proof_script(
        self, proof: ProofId, scriptLine: str, options: StrategyOptions
    ) -> MacroStatistic:
        """"""
    ...
    def proofTree_children(
        self, proof: ProofId, nodeId: TreeNodeId
    ) -> typing.List[TreeNodeDesc]:
        """"""
    ...
    def proofTree_subtree(
        self, proof: ProofId, nodeId: TreeNodeId
    ) -> typing.List[TreeNodeDesc]:
        """"""

        return as_list(TreeNodeDesc, self._call_sync("proofTree/subtree", [proof, nodeId])
