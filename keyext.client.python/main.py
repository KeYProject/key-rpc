...
def configure_callbacks(key):
    key.register_notification(
        "client/taskStarted", lambda param: print("[KeY Notification] Task started")
    )
    key.register_notification(
        "client/taskFinished", lambda param: print("[KeY Notification] Task finished")
    )
    key.register_notification(
        "client/taskProgress",
        lambda param: print("[KeY Notification] Task progress: ", param),
    )
