...
public class WebUi {
    ...
    private static void startNetty() throws Exception {
        ...
        System.out.println("WebSocket endpoint available at ws://localhost:8080/ws/jsonrpc");

        var pb = new ProcessBuilder("google-chrome", "--app=http://localhost:8080")
            .start();
        System.out.println("You can use: google-chrome --app=http://localhost:8080");
